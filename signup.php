...
if(isset($_POST['submit'])){
  ...
  $emailquery = "select * from sample where email = '$email'";
  ...
  if($emailquery_num > 0)
  {
    ...
    if($password === $cpassword){
      $insertquery = "insert into sample(username, email, mobile,  password, cpassword) values('$username','$email','$mobile','$password','$cpassword')";
